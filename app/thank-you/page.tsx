...
const ThankYouPageContent: React.FC = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-sky-900 to-zinc-900 py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="px-6 pt-6 pb-8 bg-white bg-opacity-5 sm:px-10 sm:py-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-zinc-300">
                Si tienes alguna pregunta o necesitas ajustar tu cita, no dudes en contactarnos soporte@gestiones-empresariales-campeche.cloud.
              </p>
              <div className="mt-8">
