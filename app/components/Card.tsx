      ...
      <div className="p-6 flex flex-col justify-between h-full">
        <div>
          <div className="flex items-center mb-4">
            <h3 className="text-xl 2xl:text-2xl font-bold text-white group-hover:text-green-400 transition-colors duration-300">
              {title}
            </h3>
          </div>
        ...
        <div className="mt-auto flex items-center justify-between">
          <div className="w-12 h-1 bg-green-500 rounded-full transform origin-left group-hover:scale-x-150 transition-transform duration-300 ease-out"></div>
