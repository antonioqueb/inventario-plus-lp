    ...
    <section id="consultoria-form" className="py-20 bg-gradient-to-b from-zinc-800 to-zinc-900 shadow-2xl rounded-3xl">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="bg-gradient-to-r from-yellow-600 to-yellow-800 text-white p-6 rounded-lg shadow-2xl text-center">
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg p-8 sm:p-10 rounded-2xl shadow-2xl">
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-zinc-700 border border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-white placeholder-zinc-400"
                required
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-zinc-700 border border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-white"
                min={getTodayDate() ?? ''}
                required
              />
            </div>
                ...
                {availableSlots.length === 0 ? (
                  ...
                  availableSlots.map((slot, index) => (
                    <button
                      ...
                      } transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-yellow-500`}
          ...
          <button
            type="submit"
            className="w-full mt-8 bg-gradient-to-r from-yellow-600 to-yellow-700 text-white px-6 py-4 rounded-full text-lg sm:text-xl font-bold hover:from-yellow-700 hover:to-yellow-800 transition-all duration-300 ease-in-out shadow-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:ring-offset-zinc-900"
          >
