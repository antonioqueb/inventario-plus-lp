...
const Button: React.FC<ButtonProps> = ({ text, href, variant = 'default' }) => {
  ...
  const variantClasses = {
    default: "bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 focus:ring-blue-500 my-8",
    white: "bg-white text-blue-700 border-2 border-blue-700 hover:bg-blue-50 focus:ring-blue-700 my-8"
  };
