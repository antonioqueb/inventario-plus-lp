...
const Button: React.FC<ButtonProps> = ({ text, href, variant = 'default' }) => {
  ...
  const variantClasses = {
    default: "bg-gradient-to-r from-sky-600 to-sky-700 text-white hover:from-sky-700 hover:to-sky-800 focus:ring-sky-500 my-8",
    white: "bg-white text-sky-700 border-2 border-sky-700 hover:bg-sky-50 focus:ring-sky-700 my-8"
  };
