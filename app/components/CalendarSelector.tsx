...
const CalendarSelector: React.FC<{ onSlotSelect: (slot: string) => void }> = ({ onSlotSelect }) => {
  ...
  useEffect(() => {
    ...
    fetch("https://crm.gestiones-empresariales-campeche.cloud/available_slots?start_time=2024-09-01T00:00:00&end_time=2024-09-30T23:59:59&company_id=1&user_id=2")
