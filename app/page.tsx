        ...
        >
          ...
          >
            <motion.h1 
              ...
              className="text-5xl md:text-7xl xl:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-300 to-blue-300 tracking-tight mb-8 animate-text-shimmer"
            >
              {copy.hero.title}
            </motion.h1>
