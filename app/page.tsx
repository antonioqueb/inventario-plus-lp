      ...
      >
        ...
        >
          <motion.h1 
            ...
            className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-300 to-yellow-300 tracking-tight mb-4 sm:mb-6 md:mb-8 animate-text-shimmer"
          >
            {copy.hero.title}
          </motion.h1>
      ...
      <main className="px-4 py-16 sm:px-6 lg:px-8 space-y-32">
        ...
        >
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6, delay: 0.4 }}
            viewport={{ once: true }}
            className="max-w-4xl mx-auto rounded-xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-300"
          >
            <Image
