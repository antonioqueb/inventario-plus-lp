      ...
      >
        ...
        >
          <motion.h1 
            ...
            className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-yellow-300 to-orange-300 tracking-tight mb-4 sm:mb-6 md:mb-8 animate-text-shimmer"
          >
            {copy.hero.title}
          </motion.h1>
          ...
          <motion.p 
            ...
            className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg md:text-xl lg:text-2xl text-zinc-200 max-w-7xl leading-relaxed animate-fade-in-up font-light"
          >
...
{/* <Button text={copy.hero.button} href="#consultoria-form" /> */}
      ...
      <footer className="bg-zinc-800 py-8 text-center text-white">
        <p className="text-lg">© 2024 GestPro - Soluciones Empresariales</p>
      </footer>
    </div>
  )
}
